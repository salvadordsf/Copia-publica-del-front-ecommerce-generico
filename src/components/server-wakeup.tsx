...
export default function ServerWakeUp() {
  ...
  if (status === "ready")
    return (
      <div className="flex items-center gap-3 bg-green-50 border border-green-200 rounded-xl px-5 py-4 mb-4 [animation:var(--animate-fade-in)]">
  ...
  return (
    <div className="bg-blue-50 border border-blue-200 rounded-xl px-5 py-5 mb-4 [animation:var(--animate-fade-in)]">
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="h-0.5 bg-blue-100 rounded-full mt-3 overflow-hidden">
            <div className="h-full bg-blue-500 rounded-full [animation:var(--animate-progress)]" />
          </div>
        </div>
      </div>
