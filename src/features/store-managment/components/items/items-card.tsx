...
import { useDeleteItems } from "@/features/store-managment/services/items/items-mutations";
...
export const ItemCard = ({ item, children }: ItemCardProps) => {
  ...
  return (
    ...
    "
      ...
      <CardContent className="flex flex-col flex-1 p-0 overflow-hidden">{children}</CardContent>
    </Card>
  );
};
