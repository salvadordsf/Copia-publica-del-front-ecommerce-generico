      ...
      <header className="">
        <UiBreadcrumb
          items={[
            ...
            { href: "/admin/dashboard/bulk/subcategories", label: "Acciones en lote" },
            { href: "/admin/dashboard/bulk/subcategories", label: "Subcategorías - Acciones en lote" },
          ]}
        />
        <h1 className="flex items-center gap-2 text-3xl m-2">
          <FolderTreeIcon />
          Subcategorías - Acciones en lote
        </h1>
      </header>
      <UiDivider />
      {children}
